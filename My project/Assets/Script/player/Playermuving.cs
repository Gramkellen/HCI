...
public class Playermuving : MonoBehaviour
{
    ...
    public GameObject GetojectPlayer()
    {
        GameObject oject = null;
     ...
     //   Debug.Log(xxx);
        if (isplay)
        {
           ...
           // checkdie.transform.Translate(new Vector3(0, 0, speedmuving * Time.deltaTime));
            ...
            if (Manageritem.baycoin || Manageritem.baylongcoin|| delayleftright||Slideraxspeed.IntheuseingItem)
            {
...
public void Getscore(float value)
    ...
    {
        if (coll.gameObject.tag == "speeditem")
        {
            Destroy(coll.gameObject);
          
        }
        alowjupm = true;
        if (isplay == true|| Slideraxspeed.IntheuseingItem)
        {
    ...
    void OnTriggerEnter(Collider coll)
    {
        ...
        if (coll.gameObject.tag == "coin")
        {
         ...
         //   coll.gameObject.name = "coin";
            ...
            Slideraxspeed.instance.Getvalue();
        }
        // item nhar cao
