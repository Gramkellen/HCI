  ...
  public void Getthac()
   ...
   public  void randumtheemty()
    ...
    IEnumerator emty2(float ztranform)
    {
        ...
        StartCoroutine(emty3(location.z - dx));
    }
    IEnumerator emty3(float tranformz)
    {
       ...
       StartCoroutine(emty1(location.z- dx));
    }
    IEnumerator emty4(float tranformz)
    {
        ...
        StartCoroutine(emty2(location.z- dx));
    }
    IEnumerator emty5(float tranformz)
    {
        ...
        StartCoroutine(emty6(location.z- dx));
    }
    IEnumerator emty6(float tranformz)
    {
        ...
        StartCoroutine(emty7(location.z - dx));
    ...
    IEnumerator emty7(float tranformz)
    {
        ...
        StartCoroutine(emty8(location.z - dx));
    ...
    IEnumerator emty9(float tranformz)
    {
        ...
        StartCoroutine(emty10(location.z - dx));
    ...
    IEnumerator emty10(float tranformz)
    {
        ...
        StartCoroutine(emty11(location.z - dx));
    }
    IEnumerator emty11(float tranformz)
    {
        ...
        StartCoroutine(emty12(location.z - dx));
    }
    IEnumerator emty12(float tranformz)
    {
        ...
        StartCoroutine(emty13(location.z - dx));
    }
    IEnumerator emty13(float tranformz)
    {
        ...
        StartCoroutine(emty14(location.z - dx));
    ...
    IEnumerator emty14(float tranformz)
    {
        ...
        StartCoroutine(emty15(location.z - dx));
    ...
    IEnumerator emty15(float tranformz)
    {
        ...
        StartCoroutine(emty17(location.z - dx));
        //GetchildmapEmty();
    }
    ...
    void GetPositioncoin()
    {
       
        if (valuecoinintance >= ManagerAllcoin.Count - 2)
        {
            valuecoinintance = 0;
        }
        ManagerAllcoin[valuecoinintance].transform.position = tranformcoin;
        ManagerAllcoin[valuecoinintance].SetActive(true);
        valuecoinintance++;
        
    }
    Vector3 vectorcoin = new Vector3(0,0,0);
    int valuecoinintance = 0;
    void Createcoin()
    {
        for (int i = 0; i < 300; i++)
        {
            ManagerAllcoin.Add(Instantiate(makeitemcoin, vectorcoin, transform.rotation) as GameObject);
            ManagerAllcoin[i].SetActive(false);
        }
        //coin cuối item 
        ManagerAllcoin[ManagerAllcoin.Count-2].name = "coinend";
        ManagerAllcoin[ManagerAllcoin.Count-2].gameObject.AddComponent<BoxCollider>();
        ManagerAllcoin[ManagerAllcoin.Count-2].GetComponent<BoxCollider>().isTrigger = true;
        ManagerAllcoin[ManagerAllcoin.Count-2].GetComponent<BoxCollider>().center = new Vector3(-0.177f, -120, 2.467f);
        ManagerAllcoin[ManagerAllcoin.Count-2].GetComponent<BoxCollider>().size = new Vector3(18, 273, 4);

        // coin item bay dài
        ManagerAllcoin[ManagerAllcoin.Count-1].name = "coinendtem2";
        ManagerAllcoin[ManagerAllcoin.Count-1].gameObject.AddComponent<BoxCollider>();
        ManagerAllcoin[ManagerAllcoin.Count-1].GetComponent<BoxCollider>().center = new Vector3(-0.389f, -100, 9.8f);
        ManagerAllcoin[ManagerAllcoin.Count-1].GetComponent<BoxCollider>().isTrigger = true;
        ManagerAllcoin[ManagerAllcoin.Count-1].GetComponent<BoxCollider>().size = new Vector3(20, 307, 20.1f);
        ManagerAllcoin[ManagerAllcoin.Count-1].GetComponent<SphereCollider>().center = new Vector3(0, 0, 4.4f);
    ...
    public IEnumerator creacoinforitemfly(float tranformzst)
    {
       ...
       // List<GameObject> mbitem1 = new List<GameObject>();
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            if (i == 18)
            {
                ManagerAllcoin[valuecoinintance].transform.position = tranformiteflyl;
                /// valuecoinintance++;
               
                ManagerAllcoin[ManagerAllcoin.Count - 2].gameObject.transform.position = tranformiteflybt;
                ManagerAllcoin[ManagerAllcoin.Count - 2].gameObject.SetActive(true);
                ManagerAllcoin[valuecoinintance].transform.position = tranformiteflyr;
                valuecoinintance++;
                if (valuecoinintance >= ManagerAllcoin.Count - 2)
                {
                    valuecoinintance = 0;
            ...
            ManagerAllcoin[valuecoinintance].transform.position = tranformiteflybt;
            valuecoinintance++;
            if (valuecoinintance >= ManagerAllcoin.Count - 2)
            {
                valuecoinintance = 0;
        ...
        for (int i = valuecoinintance; i > valuecoinintance-18*3; i--)
        {
            if (i<0)
            {
                ManagerAllcoin[i+( ManagerAllcoin.Count-3)].SetActive(true);
            }
            else
            {
                ManagerAllcoin[i].SetActive(true);
            }
    ...
    public IEnumerator createcoinforitemflylong(float tranformzst)
    {
        ...
        if (AlowlcreatecoinforFly)
        {
            ...
            for (int i = 0; i < maxvalue; i++)
            {
                if (i%10==0&&i>0)
                {
                 ...
                 ManagerAllcoin[valuecoinintance].transform.position = newvector;
                 ManagerAllcoin[valuecoinintance].SetActive(true);
                 mb.Add(ManagerAllcoin[valuecoinintance]);
                 valuecoinintance++;
                if (valuecoinintance >= ManagerAllcoin.Count - 2)
                {
                    valuecoinintance = 0;
            ...
            ManagerAllcoin[ManagerAllcoin.Count - 1].transform.position = mb[maxvalue - 1].transform.position;
            ManagerAllcoin[ManagerAllcoin.Count - 1].SetActive(true);
        ...
        coinend = ManagerAllcoin[ManagerAllcoin.Count - 1];
        mb.Clear();
   ...
   public static float checkshowx = 100;
    ...
    public IEnumerator MuvingbackAllemtyWenhaveitemVan(bool checkvan)
    {
        if (alowback)
        {
            ...
            //}
            Playermuving.player.gameObject.transform.position = new Vector3(0, Playermuving.player.gameObject.transform.position.y, checkshowx - 30);
    ...
    public IEnumerator MuvingbackAllemtyWendie()
    {
        ...
        if (callback)
        {
            ...
            StartCoroutine(CreateCoinWenDie(Playermuving.player.gameObject.transform.position.z + 16));
            Playermuving.player.StartCoroutine(Playermuving.player.backtotruposison());
            //if ((Playermuving.player.gameObject.transform.position.z> Map4.transform.position.z&&
            //    Playermuving.player.gameObject.transform.position.z < Map4.transform.position.z+90) 
            //    )
            //{
            //   Playermuving.player.gameObject.transform.position = 
            //   new Vector3(0, Playermuving.player.gameObject.transform.position.y, Map4.transform.position.z + 85);
            //}
            Playermuving.player.gameObject.transform.position = new Vector3(0, Playermuving.player.gameObject.transform.position.y, checkshowx-45);
            //checkshowx
        }
    }
